...
" URL:          http://www.amulet.info/vim/indent/amulet.vim
" Last Change:  2017 Jun 13
"               2005 Jun 25 - Fixed multiple bugs due to 'else\nreturn ind' working
"               2005 May 09 - Added an option to not indent Amulet-indents specially (MM)
...
setlocal expandtab
setlocal indentexpr=GetAmuletIndent()
...
if exists("*GetAmuletIndent")
 finish
endif

" Define some patterns:
let s:beflet = '^\s*\(initializer\|method\|try\)\|\(\<\(begin\|do\|else\|in\|then\|try\)\|->\|<-\|=\|;\|(\)\s*$'
let s:letpat = '^\s*\(instance|\let\|type\|module\|class\|open\|exception\|val\|include\|external\)\>'
...
let s:type = '^\s*\%(instance\|class\|let\|type\)\>'
...
function! GetAmuletIndent()
 ...
 elseif line =~ '^\s*\(class\|type\|instance\)\>'
